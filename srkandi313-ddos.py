...
port_loader = int(input(f"{Fore.LIGHTBLUE_EX}::PORT==⟩⟩ {Fore.LIGHTYELLOW_EX }"))
time_loader = time.time() + int(input(f"{Fore.LIGHTBLUE_EX}::TIME ==⟩⟩ {Fore.LIGHTYELLOW_EX}"))
spam_loader = int(input(f"{Fore.LIGHTBLUE_EX}::SPAM THREAD ==⟩⟩ {Fore.LIGHTYELLOW_EX}"))
create_thread = int(input(F"{Fore.LIGHTBLUE_EX}::CREATE THREAD ==⟩⟩ {Fore.LIGHTYELLOW_EX}"))
booter_sent = int(input(F"{Fore.LIGHTBLUE_EX}::BOOTER SENT ==⟩⟩ {Fore.LIGHTYELLOW_EX}"))
print(f"{Fore.LIGHTBLUE_EX}::HTTP_METHODS ==⟩ {Fore.LIGHTYELLOW_EX}")
